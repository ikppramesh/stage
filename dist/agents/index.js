...
exports.DEFAULT_AGENT_ID = exports.AGENTS = exports.CATEGORIES = void 0;
...
exports.DEFAULT_AGENT_ID = "software-engineer";
...
function getAgentsByCategory() {
    return exports.CATEGORIES
        .map(cat => ({
        category: cat,
        agents: exports.AGENTS.filter(a => a.category === cat)
    }))
